...
var
  ...
  targetPath = path.join(__dirname, '../../AuthManagerAPI/src/main/webapp')
...
shell.rm('-R', targetPath + '/fonts')
shell.rm('-R', targetPath + '/img')
shell.rm('-R', targetPath + '/js')
shell.rm('-R', targetPath + '/app.*.css')
shell.rm('-R', targetPath + '/index.html')
